...
function generateDefaulCalloutOptions(): Suggestion[] {
    ...
    return [
        ...
        newSuggestion("corollary", "corollary", "lucide-square-sigma", "#ff79c6"),
        newSuggestion("danger", "danger", ...DANGER),
        newSuggestion("definition", "definition", "lucide-pencil", "#bd93f9"),
        newSuggestion("Done", "done", ...SUCCESS),
        newSuggestion("equation", "equation", "lucide-calculator", "#bd93f9"),
        ...
        newSuggestion("figure", "figure", "lucide-pencil", "#ff79c6"),
